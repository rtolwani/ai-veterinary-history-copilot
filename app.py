...
def main():
    def update_diagnosis():
        with col3:
            diagnosis_name = st.selectbox("Choose a Differential for Treatment Plan. Change Selection for Another Plan:", st.session_state['diagnoses'])
    ...
    with col1:
        conversation = st.text_area("Enter Patient History. Modify to Update SOAP and Differentials", height=450)  # Increase textarea height
